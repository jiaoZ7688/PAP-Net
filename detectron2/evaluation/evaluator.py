...
def inference_on_dataset(
    ...
    with ExitStack() as stack:
        ...
        for idx, inputs in enumerate(data_loader):
            ...
            # a1=[outputs[0]["instances"].pred_boxes]
            # a2=[outputs[0]["instances"].scores]
            # a3=[outputs[0]["instances"].pred_classes]
            # print("pred_boxes")
            # print(a1)
            # print("scores")
            # print(a2)
            # print("pred_classes")
            # print(a3)          
            # a11=[outputs[0]["instances"].pred_visible_masks.shape]
            # a22=[outputs[0]["instances"].pred_masks.shape]
            # a33=[outputs[0]["instances"].pred_occluder_masks.shape]
            # a111=[outputs[0]["instances"].pred_visible_masks]
            # a222=[outputs[0]["instances"].pred_masks]
            # a333=[outputs[0]["instances"].pred_occluder_masks]
            # print("pred_visible_masks")
            # print(a11)
            # print("pred_masks")
            # print(a22)
            # print("pred_occluder_masks")
            # print(a33)   
